...
const JA_NAME_MAP = {
  ...
  'Trey Murphy III'         : 'トレイ・マーフィーIII',
  'Cooper Flagg'            : 'クーパー・フラッグ',
  'Zion Williamson'         : 'ザイオン・ウィリアムソン',
  'Nickeil Alexander-Walker': 'ニッケイル・アレクサンダー=ウォーカー',
  ...
  'Derrick White'           : 'デリック・ホワイト',
  'Matas Buzelis'           : 'マタス・ブゼリス',
  'VJ Edgecombe'            : 'VJエッジコム',
  'Scotty Pippen Jr.'       : 'スコッティ・ピッペンJr.',
  'Tyus Jones'              : 'タイアス・ジョーンズ',
  'Fred VanVleet'           : 'フレッド・バンブリート',
  'Tre Jones'               : 'トレ・ジョーンズ',
  'Grayson Allen'           : 'グレイソン・アレン',
  'Pat Connaughton'         : 'パット・コノートン',
  'Bobby Portis'            : 'ボビー・ポーティス',
  'Brook Lopez'             : 'ブルック・ロペス',
  'Malik Beasley'           : 'マリク・ビーズリー',
  'MarJon Beauchamp'        : 'マーヨン・ボーシャン',
  'AJ Green'                : 'AJグリーン',
  'Damian Lillard'          : 'デイミアン・リラード',
  'Chris Livingston'        : 'クリス・リビングストン',
  'Kyle Kuzma'              : 'カイル・クズマ',
  'Jordan Nwora'            : 'ジョーダン・ンウォラ',
  'Patrick Beverley'        : 'パトリック・ベバリー',
  'Bogdan Bogdanovic'       : 'ボグダン・ボグダノビッチ',
  'Trae Young'              : 'トレイ・ヤング',
  'Clint Capela'            : 'クリント・カペラ',
  'De'Andre Hunter'        : 'デアンドレ・ハンター',
  'Onyeka Okongwu'          : 'オニエカ・オコングウー',
  'Dyson Daniels'           : 'ダイソン・ダニエルズ',
  'Larry Nance Jr.'         : 'ラリー・ナンスJr.',
  'Garrison Mathews'        : 'ギャリソン・マシューズ',
  'Vit Krejci'              : 'ビット・クレイチ',
  'Seth Lundy'              : 'セス・ランディ',
  'Kris Murray'             : 'クリス・マレー',
  'Scoot Henderson'         : 'スクート・ヘンダーソン',
  'Shaedon Sharpe'          : 'シェードン・シャープ',
  'Jerami Grant'            : 'ジェラミ・グラント',
  'Robert Williams III'     : 'ロバート・ウィリアムズIII',
  ...
  'Cade Cunningham'         : 'ケイド・カニングハム',
  'Tim Hardaway Jr.'        : 'ティム・ハーダウェイJr.',
  'Ausar Thompson'          : 'オーサー・トンプソン',
  'Ron Holland II'          : 'ロン・ホランドII',
  'Isaiah Stewart'          : 'アイザイア・スチュワート',
  'Tobias Harris'           : 'トバイアス・ハリス',
  'Ja Morant'               : 'ジャ・モラント',
  'Jaren Jackson Jr.'       : 'ジャレン・ジャクソンJr.',
  'Desmond Bane'            : 'デズモンド・ベイン',
  ...
  'GG Jackson'              : 'GGジャクソン',
  'Cam Spencer'             : 'カム・スペンサー',
  'Zach LaVine'             : 'ザック・ラビーン',
  'Nikola Vucevic'          : 'ニコラ・ブチェビッチ',
  'Ayo Dosunmu'             : 'アヨ・ドスンム',
  'Josh Giddey'             : 'ジョシュ・ギデイ',
  'Coby White'              : 'コービー・ホワイト',
  'Patrick Williams'        : 'パトリック・ウィリアムズ',
  'Myles Turner'            : 'マイルズ・ターナー',
  'Bennedict Mathurin'      : 'ベネジクト・マチュリン',
  'Andrew Nembhard'         : 'アンドリュー・ネンバード',
  'T.J. McConnell'          : 'TJマクコネル',
  ...
  'Jaden Springer'          : 'ジェイデン・スプリンガー',
  'Svi Mykhailiuk'          : 'スヴィ・ミハイリューク',
  ...
  'Ace Bailey'              : 'エース・ベイリー',
  'Adem Bona'               : 'アデム・ボナ',
  'Amen Thompson'           : 'エイメン・トンプソン',
  'Andre Drummond'          : 'アンドレ・ドラモンド',
  'Anthony Black'           : 'アンソニー・ブラック',
  'Baylor Scheierman'       : 'ベイラー・シャイアーマン',
  'Ben Sheppard'            : 'ベン・シェパード',
  'Bones Hyland'            : 'ボーンズ・ハイランド',
  'Brandin Podziemski'      : 'ブランディン・ポジェムスキー',
  'Brandon Williams'        : 'ブランドン・ウィリアムズ',
  'Brice Sensabaugh'        : 'ブライス・センサボー',
  'Bruce Brown'             : 'ブルース・ブラウン',
  'Bub Carrington'          : 'バブ・キャリントン',
  'CJ McCollum'             : 'CJマッカラム',
  'Caleb Martin'            : 'カレブ・マーティン',
  'Caris LeVert'            : 'カリス・ルバート',
  'Carter Bryant'           : 'カーター・ブライアント',
  'Cason Wallace'           : 'ケイソン・ウォレス',
  'Cedric Coward'           : 'セドリック・カワード',
  'Cody Williams'           : 'コーディ・ウィリアムズ',
  'Collin Gillespie'        : 'コリン・ギレスピー',
  'Corey Kispert'           : 'コーリー・キスパート',
  'Craig Porter Jr.'        : 'クレイグ・ポーターJr.',
  'Daniss Jenkins'          : 'ダニス・ジェンキンス',
  'Davion Mitchell'         : 'デイビオン・ミッチェル',
  "Day'Ron Sharpe"          : 'デイロン・シャープ',
  "De'Aaron Fox"            : 'ダアロン・フォックス',
  'Dean Wade'               : 'ディーン・ウェイド',
  'Deandre Ayton'           : 'ディアンドレ・エイトン',
  'Derik Queen'             : 'デリック・クイーン',
  'Dominick Barlow'         : 'ドミニク・バーロー',
  'Drake Powell'            : 'ドレイク・パウエル',
  'Dru Smith'               : 'ドルー・スミス',
  'Duncan Robinson'         : 'ダンカン・ロビンソン',
  'Dwight Powell'           : 'ドワイト・パウエル',
  'Dylan Harper'            : 'ディラン・ハーパー',
  'Gary Trent Jr.'          : 'ゲイリー・トレントJr.',
  'Goga Bitadze'            : 'ゴガ・ビタゼ',
  'Gradey Dick'             : 'グレイディ・ディック',
  'Guerschon Yabusele'      : 'ゲルション・ヤブセレ',
  'Gui Santos'              : 'ギ・サントス',
  'Harrison Barnes'         : 'ハリソン・バーンズ',
  'Hugo González'           : 'ウーゴ・ゴンザレス',
  'Isaac Okoro'             : 'アイザック・オコロ',
  "Ja'Kobe Walter"          : 'ジャコービー・ウォルター',
  'Jabari Smith Jr.'        : 'ジャバリ・スミスJr.',
  'Jabari Walker'           : 'ジャバリ・ウォーカー',
  'Jaden McDaniels'         : 'ジェイデン・マクダニエルズ',
  'Jaime Jaquez Jr.'        : 'ハイメ・ハケスJr.',
  'Jake LaRavia'            : 'ジェイク・ラレイビア',
  'Jamal Shead'             : 'ジャマール・シェッド',
  'Jamison Battle'          : 'ジャミソン・バトル',
  'Jarace Walker'           : 'ジャレース・ウォーカー',
  'Jared McCain'            : 'ジャレッド・マケイン',
  'Jarred Vanderbilt'       : 'ジャレッド・バンダービルト',
  'Javonte Green'           : 'ジャボンテ・グリーン',
  'Jaxson Hayes'            : 'ジャクソン・ヘイズ',
  'Jay Huff'                : 'ジェイ・ハフ',
  'Jaylen Clark'            : 'ジェイレン・クラーク',
  'Jaylen Wells'            : 'ジェイレン・ウェルズ',
  'Jaylin Williams'         : 'ジェイリン・ウィリアムズ',
  'Jaylon Tyson'            : 'ジェイロン・タイソン',
  'Jeremiah Fears'          : 'ジェレマイア・フィアーズ',
  'Jericho Sims'            : 'ジェリコ・シムズ',
  'Jock Landale'            : 'ジョック・ランデール',
  'Jonas Valančiūnas'       : 'ジョナス・バランチュナス',
  'Jordan Goodwin'          : 'ジョーダン・グッドウィン',
  'Jordan Miller'           : 'ジョーダン・ミラー',
  'Jose Alvarado'           : 'ホセ・アルバラード',
  'Josh Green'              : 'ジョシュ・グリーン',
  'Josh Okogie'             : 'ジョシュ・オコギー',
  'Julian Champagnie'       : 'ジュリアン・シャンパニー',
  'Justin Champagnie'       : 'ジャスティン・シャンパニー',
  'Justin Edwards'          : 'ジャスティン・エドワーズ',
  'Karlo Matković'          : 'カルロ・マトコビッチ',
  "Kel'el Ware"             : 'ケレル・ウェア',
  'Keon Ellis'              : 'キオン・エリス',
  'Kevin Huerter'           : 'ケビン・ヒュルター',
  'Kobe Brown'              : 'コービー・ブラウン',
  'Kobe Sanders'            : 'コービー・サンダース',
  'Kon Knueppel'            : 'コン・クニュッペル',
  'Kris Dunn'               : 'クリス・ダン',
  'Kyle Filipowski'         : 'カイル・フィリポウスキー',
  'Luka Garza'              : 'ルカ・ガルザ',
  'Malik Monk'              : 'マリク・モンク',
  'Mark Williams'           : 'マーク・ウィリアムズ',
  'Marvin Bagley III'       : 'マービン・バグリーIII',
  'Max Christie'            : 'マックス・クリスティー',
  'Maxime Raynaud'          : 'マキシム・レイノー',
  'Micah Peavy'             : 'マイカ・ピービー',
  'Mitchell Robinson'       : 'ミッチェル・ロビンソン',
  'Mohamed Diawara'         : 'モハメド・ジャワラ',
  'Mouhamed Gueye'          : 'モハメド・ゲイ',
  'Moussa Diabaté'          : 'ムサ・ジャバテ',
  "Nae'Qwan Tomlin"         : 'ネクウォン・トムリン',
  'Naji Marshall'           : 'ナジ・マーシャル',
  'Naz Reid'                : 'ナズ・リード',
  'Neemias Queta'           : 'ネイミアス・クエタ',
  'Nicolas Batum'           : 'ニコラ・バトゥム',
  'Nique Clifford'          : 'ニック・クリフォード',
  'Noah Clowney'            : 'ノア・クラウニー',
  'Noah Penda'              : 'ノア・ペンダ',
  'Ochai Agbaji'            : 'オチャイ・アグバジ',
  'Oso Ighodaro'            : 'オソ・イゴダロ',
  'Pat Spencer'             : 'パット・スペンサー',
  'Paul Reed'               : 'ポール・リード',
  'Pelle Larsson'           : 'ペレ・ラーソン',
  'Quinten Post'            : 'クィンテン・ポスト',
  'Rayan Rupert'            : 'ライアン・ルパート',
  'Reed Sheppard'           : 'リード・シェパード',
  'Rob Dillingham'          : 'ロブ・ディリンガム',
  'Ronald Holland II'       : 'ロナルド・ホランドII',
  "Royce O'Neale"           : 'ロイス・オニール',
  'Ryan Dunn'               : 'ライアン・ダン',
  'Ryan Kalkbrenner'        : 'ライアン・カルクブレナー',
  'Ryan Nembhard'           : 'ライアン・ネンバード',
  'Sandro Mamukelashvili'   : 'サンドロ・マムケラシュビリ',
  'Sidy Cissoko'            : 'シディ・シソコ',
  'Simone Fontecchio'       : 'シモーネ・フォンテッキオ',
  'Sion James'              : 'サイオン・ジェームズ',
  'Spencer Jones'           : 'スペンサー・ジョーンズ',
  'Tari Eason'              : 'タリ・イーソン',
  'Terance Mann'            : 'テランス・マン',
  'Thomas Bryant'           : 'トーマス・ブライアント',
  'Tre Johnson'             : 'トレ・ジョンソン',
  'Tristan da Silva'        : 'トリスタン・ダ・シルバ',
  'Tyler Kolek'             : 'タイラー・コレック',
  'Walter Clayton Jr.'      : 'ウォルター・クレイトンJr.',
  'Wendell Carter Jr.'      : 'ウェンデル・カーターJr.',
  'Will Richard'            : 'ウィル・リチャード',
  'Will Riley'              : 'ウィル・ライリー',
  'Yves Missi'              : 'イブ・ミシ',
  'Zaccharie Risacher'      : 'ザカリー・リサシェ',
};
