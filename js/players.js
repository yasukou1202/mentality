...
async function openPlayerDetail(name, team) {
  ...
  try {
    ...
    document.getElementById('playerDetailBody').innerHTML = `
      ...
      <div style="overflow-x:scroll;-webkit-overflow-scrolling:touch;border-radius:6px;border:1px solid var(--bd);margin-bottom:.6rem;">
        <table style="width:100%;border-collapse:collapse;font-size:.62rem;min-width:480px;">
