...
async function loadPlayersFromAPI() {
  ...
  try {
    ...
    const url = `https://yasukou1202.github.io/mentality/data.json?v=1779410136`;
...
async function openPlayerDetail(name, team) {
  ...
  content.innerHTML = `
    <div style="background:linear-gradient(135deg,#0a1628,#1d428a);padding:max(env(safe-area-inset-top),60px) 1rem .6rem;">
