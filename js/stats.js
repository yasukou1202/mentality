...
async function loadESPNLeaders(stat, mode) {
  ...
  try {
    ...
    // ESPN スタッツリーダーAPI
    const url = `https://corsproxy.io/?https://site.api.espn.com/apis/site/v2/sports/basketball/nba/leaders?limit=15&season=2025&seasontype=${seasontype}`;
...
async function renderStandings() {
  ...
  try {
    ...
    const res = await fetchWithTimeout(
      `https://corsproxy.io/?https://site.api.espn.com/apis/v2/sports/basketball/nba/standings?season=2025&seasontype=${seasontype}`,
      {}, 8000
    );
